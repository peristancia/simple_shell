 ...
 * @linecount_flag: this is the line count
 * @fname: the filename
 * @env: the linked list local copy of environ
 * @environ: this is thecustom modified copy of environ from LL env
 * @history: the history node
 * @alias: this is the alias node
 * @env_changed: if environ was changed
 * @status: the last exec'd command status
 * @cmd_buf: cmd_buf pointer, on if chaining
 * @cmd_buf_type: the CMD_type ||, &&, ;
 * @readfd: this is the readable filedescriptor
 * @histcount: this counts the number of history line
 */
...
/**
 * struct builtin - this has builtin string and related function
